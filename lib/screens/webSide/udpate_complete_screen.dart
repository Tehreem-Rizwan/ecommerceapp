...
class UpdateCompeleteScreen extends StatefulWidget {
  static const String id = "updateComplete";

  @override
  State<UpdateCompeleteScreen> createState() => _UpdateCompeleteScreenState();
}

class _UpdateCompeleteScreenState extends State<UpdateCompeleteScreen> {
